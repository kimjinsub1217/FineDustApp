package com.example.toyproject018_finedust.appwidget
                ...
                .addOnSuccessListener { location ->
                    lifecycleScope.launch {
                        try {
                            ...
                            val nearbyMonitoringStation = Respository.getNearbyMonitoringStation(
                                location.latitude,
                                location.longitude
                            )
                            val measuredValue =
                                Respository.getLatestAirQualityData(nearbyMonitoringStation!!.stationName!!)
                            val updateViews =
